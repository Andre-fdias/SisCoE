    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prontidao', models.CharField(default='', max_length=18)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('situacao', models.CharField(choices=[('', ' '), ('Efetivo', 'Efetivo'), ('Exonerado a Pedido', 'Exonerado a Pedido'), ('Exonerado Ex-Ofício', 'Exonerado Ex-Ofício'), ('Reserva a Pedido', 'Reserva a Pedido'), ('Transferido', 'Transferido'), ('Mov. Interna', 'Mov. Interna')], default='Efetivo', max_length=30)),
                ('cat_efetivo', models.CharField(choices=[('', ' '), ('ATIVO', 'ATIVO'), ('INATIVO', 'INATIVO'), ('LSV', 'LSV'), ('LTS', 'LTS'), ('LTS FAMILIA', 'LTS FAMILIA'), ('CONVAL', 'CONVAL'), ('ELEIÇÃO', 'ELEIÇAO'), ('LP', 'LP'), ('FERIAS', 'FÉRIAS')], default='Ativo', max_length=30)),
                ...
                ('prontidao', models.CharField(choices=[('', ' '), ('VERDE', 'VERDE'), ('AMARELA', 'AMARELA'), ('AZUL', 'AZUL'), ('ADM', 'ADM')], default='', max_length=18)),
                ('apresentacao_na_unidade', models.DateField()),
                ('saida_da_unidade', models.DateField(blank=True, null=True)),
                ('data_alteracao', models.DateTimeField(auto_now_add=True)),
            ...
            options={
                'indexes': [models.Index(fields=['situacao', 'posto_secao'], name='efetivo_det_situaca_63d18d_idx'), models.Index(fields=['cadastro'], name='efetivo_det_cadastr_9af3c3_idx')],
            },
        ),
        migrations.CreateModel(
            name='Promocao',
            ...
            options={
                'indexes': [models.Index(fields=['grupo'], name='efetivo_pro_grupo_b03f27_idx'), models.Index(fields=['cadastro'], name='efetivo_pro_cadastr_bc40b7_idx')],
            },
        ),
    ]
