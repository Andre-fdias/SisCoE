...
class Cadastro_bm(models.Model):
    ...
    posto_secao = models.CharField(
        max_length=100, blank=False, null=False, choices=posto_secao_choices
    )
    ...
    cat_cnh = models.CharField(
        max_length=4, blank=False, null=False, choices=cat_cnh_choices
    )
    ...
    funcao = models.CharField(
        max_length=50, blank=False, null=False, choices=funcao_choices
    )
...
class Imagem_bm(models.Model):
    cadastro = models.ForeignKey(
        Cadastro_bm, on_delete=models.CASCADE, related_name="imagens"
    )
