...
def export_to_pdf_military(request, data):
    ...
    try:
        ...
        logo_direita = Image(
            get_image_path("brasao.png"), width=20 * mm, height=20 * mm
        )
        ...
        table_style = TableStyle(
            [
                (
                    ...
                    (0, 0),
                    "CENTER",
                ),  # Alinha a imagem da esquerda ao centro
                ...
                (
                    ...
                    (2, 0),
                    "CENTER",
                ),  # Alinha a imagem da direita ao centro
            ]
        )
        ...
        header_table = Table(
            [
                [
                    logo_esquerda,
                    Paragraph(
                        "Corpo de Bombeiros do Estado de São Paulo<br/>Comando de Bombeiros do Interior - 1<br/>15º Grupamento de Bombeiros",
        ...
        elements.append(
            Paragraph(
                f"Erro ao carregar logos ou cabeçalho: {str(e)}", styles["Normal"]
            )
        )
    ...
    elements.append(
        Paragraph(f"Total de Bombeiros Municipais: {total_bom}", styles["Normal"])
    )
