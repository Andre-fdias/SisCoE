...
class CadastroBmAdmin(admin.ModelAdmin):
    list_display = ['nome', 'nome_de_guerra', 'situacao', 'sgb', 'posto_secao', 'cpf', 'esb', 'ovb']
    ...
    fieldsets = [
        ('Informações Pessoais', {
            'fields': [
                'nome', 'nome_de_guerra', 'genero', 'cpf', 'rg',
                'nasc', 'email', 'telefone'
            ]
        }),
        ('Situação Militar', {
            'fields': [
                'situacao', 'sgb', 'posto_secao', 'funcao',
                'admissao', 'apresentacao_na_unidade', 'saida_da_unidade'
            ]
        }),
        ...
        ('Auditoria', {
            'fields': [
                'user', 'usuario_alteracao', 'create_at', 'data_alteracao'
            ],
            'classes': ['collapse']
        })
    ]
