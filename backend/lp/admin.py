...
class LPAdmin(admin.ModelAdmin):
    ...
    search_fields = (
        "cadastro__nome",
        "cadastro__re",
        "cadastro__nome_de_guerra",  # Use 'nome_de_guerra'
        "observacoes",
        "bol_g_pm_lp",
    )
...
class HistoricoLPAdmin(admin.ModelAdmin):
    ...
    search_fields = (
        "lp__cadastro__nome",
        "lp__cadastro__re",
        "lp__cadastro__nome_de_guerra",  # Use 'nome_de_guerra'
...
class LPFruicaoAdmin(admin.ModelAdmin):
    ...
    search_fields = (
        "cadastro__nome",
        "cadastro__re",
        "cadastro__nome_de_guerra",
        "bol_g_pm_lp",
        "lp_concluida__numero_lp",
    )
    readonly_fields = (
        "data_cadastro",
        "data_atualizacao",
    ...
    fieldsets = (
        ...
        (
            "Fruição da LP",
            {
                "fields": ("tipo_choice", "tipo_periodo_afastamento", "bol_g_pm_lp"),
            },
        ),
        (
            "Auditoria",
