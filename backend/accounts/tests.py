...
class UserModelTest(TestCase):
    ...
    def setUp(self):
        ...
        self.superuser = User.objects.create_superuser(
            email="super@email.com", password="superpassword123"
        )
...
class AuthenticationFormsTest(TestCase):
    ...
    def test_custom_authentication_form(self):
        ...
        form_data = {"username": "test@email.com", "password": "testpassword123"}
    ...
    def test_password_change_form(self):
        ...
        user = User.objects.create_user(
            email="test@email.com", password="oldpassword123"
        )
...
class ViewsTest(TestCase):
    ...
    def test_login_view_post_success(self):
        ...
        response = self.client.post(
            ...
            {"username": "test@email.com", "password": "testpassword123"},
        )
    ...
    def test_login_view_post_failure(self):
        ...
        response = self.client.post(
            reverse("accounts:login"),
            {"username": "test@email.com", "password": "wrongpassword"},
        )
...
class PermissionTest(TestCase):
    ...
    def setUp(self):
        ...
        self.basico_user = User.objects.create_user(
            email="basico@email.com", password="password123", permissoes="basico"
        )
        self.gestor_user = User.objects.create_user(
            email="gestor@email.com", password="password123", permissoes="gestor"
        )
...
class ForcePasswordChangeTest(TestCase):
    ...
    def setUp(self):
        self.client = Client()
        self.user = User.objects.create_user(
            email="test@email.com", password="tempassword123", must_change_password=True
        )
...
class ProfileModelTest(TestCase):
    ...
    def test_profile_creation(self):
        ...
        profile = Profile.objects.create(
            user=self.user, bio="Test biography", avatar=None
        )
...
class UserManagerTest(TestCase):
    ...
    def test_create_user(self):
        ...
        user = User.objects.create_user(
            email="manager@email.com", password="password123"
        )
    ...
    def test_create_superuser(self):
        ...
        superuser = User.objects.create_superuser(
            email="supermanager@email.com", password="password123"
        )
...
class IntegrationTest(TestCase):
    ...
    def test_complete_user_flow(self):
        ...
        login_success = self.client.login(
            email="integration@email.com", password="password123"
        )
...
class SecurityTest(TestCase):
    ...
    def test_brute_force_protection(self):
        ...
        for i in range(5):
            response = self.client.post(
                reverse("accounts:login"),
                {"username": "nonexistent@email.com", "password": f"wrongpassword{i}"},
            )
...
class URLTest(TestCase):
    ...
    def setUp(self):
        self.client = Client()
        self.user = User.objects.create_user(
            email="url_test@email.com", password="password123"
        )
