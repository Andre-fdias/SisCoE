...
INSTALLED_APPS = [
    ...
    # Apps ASÍNCRONOS (Channels deve vir depois dos apps síncronos)
    'channels',
...
# No seu settings/base.py ou production.py
ASGI_APPLICATION = 'backend.asgi.application'

# Garantir que o Redis está configurado corretamente
CHANNEL_LAYERS = {
    'default': {
...
DATABASES = {
    'default': {
        ...
        'CONN_MAX_AGE': 60,  # Conexões persistentes para melhor performance
        'OPTIONS': {
            'connect_timeout': 10,
        }
    }
...
EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD', default=BREVO_API_KEY)
