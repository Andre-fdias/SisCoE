...
class SimpleRptTest(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(
            email="simple@test.com", password="testpass123"
        )
...
class CadastroRptOnlyTest(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(
            email="rptonly@test.com", password="testpass123"
        )
...
class MinimalViewsTest(TestCase):
    ...
    def setUp(self):
        self.client = Client()
        self.user = User.objects.create_user(
            email="minimal@test.com", password="testpass123"
        )
    ...
    def test_editar_rpt_get(self):
        ...
        response = self.client.get(
            reverse("rpt:editar_rpt", args=[self.cadastro_rpt.id])
        )
...
class HistoricoRptTest(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(
            email="historico@test.com", password="testpass123"
        )
...
class CadastroRptPropertiesTest(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(
            email="props@test.com", password="testpass123"
        )
...
class FixedHistoricoRptTest(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(
            email="fixed@test.com", password="testpass123"
        )
...
class FinalSmokeTest(TestCase):
    ...
    def test_smoke_test(self):
        ...
        user = User.objects.create_user(email="smoke@test.com", password="testpass123")
