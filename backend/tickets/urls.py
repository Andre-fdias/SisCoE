# Este arquivo será reescrito para evitar importações circulares.
from django.urls import path

# As views serão importadas aqui para garantir que o carregamento seja feito corretamente.
from . import views
...
urlpatterns = [
    ...
    path(
        "chamado-sucesso/<str:protocolo>/",
        views.chamado_sucesso,
