...
urlpatterns = [
    ...
    path(
        "editar-geral/<int:id>/", views.editar_cadastro_adicional, name="editar_geral"
    ),
    path(
        "excluir-adicional/<int:id>/", views.excluir_adicional, name="excluir_adicional"
    ),
    # URLs para histórico e ações específicas
    path(
        "historico-adicional/<int:id>/",
        views.historico_adicional,
        name="historico_adicional",
    ),
    path(
        "concluir-adicional/<int:id>/",
        views.concluir_adicional,
        name="concluir_adicional",
    ),
    # URLs para operações específicas
    path(
        "editar-dias-desconto/<int:pk>/",
        views.editar_dias_desconto,
        name="editar_dias_desconto",
    ),
    ...
    path(
        "carregar-dados-sipa/<int:pk>/",
        views.carregar_dados_sipa,
        name="carregar_dados_sipa",
    ),
