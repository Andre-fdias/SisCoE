    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numero_prox_lp', models.PositiveSmallIntegerField(choices=[(1, '01'), (2, '02'), (3, '03'), (4, '04'), (5, '05'), (6, '06'), (7, '07'), (8, '08')], default=1, verbose_name='Próximo Número da LP')),
                ...
                ('status_lp', models.CharField(choices=[('aguardando_requisitos', 'Aguardando Requisitos'), ('faz_jus', 'Faz Jus'), ('lancado_sipa', 'Lançado em SIPA'), ('aguardando_publicacao', 'Aguardando Publicação'), ('publicado', 'Publicado'), ('encerrado', 'Encerrado')], default='aguardando_requisitos', max_length=30, verbose_name='Status da LP')),
                ('cadastro', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='efetivo.cadastro', verbose_name='Cadastro')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usuario_alteracao', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Usuário que Alterou')),
                ('lp', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='adicional.lp')),
            ],
        ),
    ]
