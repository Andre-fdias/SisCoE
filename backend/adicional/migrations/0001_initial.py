# Generated by Django 5.1.4 on 2025-03-12 15:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('situacao_adicional', models.CharField(choices=[('', ' '), ('Aguardando', 'Aguardando'), ('Concedido', 'Concedido')], default='Aguardando', max_length=30)),
                ...
                ('situacao_lp', models.CharField(choices=[('', ' '), ('Aguardando', 'Aguardando'), ('Concedido', 'Concedido')], default='Aguardando', max_length=30)),
