...
from .views import index, capa, CalendarioView, dashboard_view, global_search_view, dashboard_links_view, privacy_policy_view, termo_aceite_view
...
urlpatterns = [
    ...
    path("termo-aceite/", termo_aceite_view, name="termo_aceite"),
]
