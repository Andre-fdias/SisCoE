...
class UtilsTests(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(
            email="utils@example.com", password="testpass123"
        )
...
class URLTests(TestCase):
    ...
    def setUp(self):
        self.client = Client()
        self.user = User.objects.create_user(
            email="url_test@example.com", password="testpass123"
        )
...
def test_homepage_status_code(client):
    ...
    user = User.objects.create_user(email="pytest@example.com", password="testpass123")
...
class PerformanceTests(TestCase):
    ...
    def setUp(self):
        self.client = Client()
        self.user = User.objects.create_user(
            email="performance@example.com", password="testpass123"
        )
...
class ErrorHandlingTests(TestCase):
    ...
    def setUp(self):
        self.client = Client()
        self.user = User.objects.create_user(
            email="error_test@example.com", password="testpass123"
        )
...
class TemplateRenderingTests(TestCase):
    ...
    def setUp(self):
        self.client = Client()
        self.user = User.objects.create_user(
            email="template@example.com", password="testpass123"
        )
