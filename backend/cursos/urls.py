...
urlpatterns = [
    ...
    path(
        "medalhas/buscar-militar/",
        views.buscar_militar_medalha,
        name="buscar_militar_medalha",
    ),
    ...
    path(
        "medalhas/importar/",
        views.importar_medalhas_view,
        name="importar_medalhas_view",
    ),
    ...
    path(
        "cursos/buscar-militar/",
        views.buscar_militar_curso,
        name="buscar_militar_curso",
    ),
    ...
    path(
        "meus-cursos/novo/", views.user_curso_create, name="user_curso_create"
    ),  # NOME CORRIGIDO
    path("meus-cursos/<int:pk>/editar/", views.user_curso_edit, name="user_curso_edit"),
    path(
        "meus-cursos/<int:pk>/excluir/",
        views.user_curso_delete,
        name="user_curso_delete",
    ),
    ...
    path(
        "meus-medalhas/novo/", views.user_medalha_create, name="user_medalha_create"
    ),  # Linha corrigida
    path(
        "meus-medalhas/editar/<int:pk>/",
        views.user_medalha_edit,
        name="user_medalha_edit",
    ),
    path(
        "meus-medalhas/excluir/<int:pk>/",
        views.user_medalha_delete,
        name="user_medalha_delete",
    ),
]
