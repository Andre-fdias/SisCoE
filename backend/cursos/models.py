...
class Curso(models.Model):
    ...
    CURSOS_CHOICES = (
        ...
        ('BCPSOP_1CFO', 'Bacharel em Ciências Policiais de Segurança e Ordem Pública - Praça ou Civil - APMBB - 2,5 1º CFO'),
        ('BCPSOP_2CFO', 'Bacharel em Ciências Policiais de Segurança e Ordem Pública - Praça ou Civil - APMBB - 2,5 2º CFO'),
        ('BCPSOP_3CFO', 'Bacharel em Ciências Policiais de Segurança e Ordem Pública - Praça ou Civil - APMBB - 2,5 3º CFO'),
        ('CSTAPM', 'Curso Superior de Tecnólogo de Administração Policial-Militar'),
        ('CEP_Comunicação Social_Praça', 'Comunicação Social - Praça - 1'),
        ('CEP_Comunicação Social_Oficial', 'Comunicação Social - Cap PM e Ten PM - 2,5'),
        ('CEP_Segurança Institucional_Praça', 'Segurança Institucional - Praça - 1'),
        ('CEP_Segurança Institucional_Oficial', 'Segurança Institucional - Oficial - 2,5'),
        ('CEP_Gestores de Defesa Civil', 'Gestores de Defesa Civil - Oficial e Praça - 1'),
        ('PDCPSOP', 'Programa de Doutorado em Ciências Policiais de Segurança e Ordem Pública - Ten Cel PM ou Maj PM - 4,5'),
        ('PMPCPSOP', 'Programa de Mestrado Profissional em Ciên. Policiais de Segurança e Ordem Pública - Cap PM - 3,5'),
        ('CEP_Operador Saúde Mental', 'Operador do Sistema de Saúde Mental - Oficial ou Praça - 1'),
        ('CEP_Comandante Operações Aéreas', 'Comandante de Operações Aéreas - Oficial - 2,5'),
        ('CEP_Operador RPAS', 'Operador de RPAS (Remotely Piloted Aircraft System) - Oficial ou Praça - 1'),
        ('CEP_Tripulante Operacional', 'Tripulante Operacional - Praça - 1'),
        ('EEP_Voo avançado', 'Voo avançado - Oficial - 2,5'),
        ('CEP_Piloto Helicóptero', 'Piloto Policial de Helicóptero - Oficial - 2,5'),
        ('EEP_Pressurização Escadas', 'Credenciamento Avançado em Pressurização de Escadas de Emergência - Oficial, Subten PM ou Sgt PM - 1'),
        ('EEP_Operação Bancos Dados', 'Operação de Bases de Dados Criminais - Oficial ou Praça - 1'),
        ('CEP_Inteligência Praças', 'Inteligência Policial para Praças - Praças - 1'),
        ('CEP_Inteligência Oficiais', 'Inteligência Policial para Oficiais - Oficiais - 2,5'),
        ('CEP_Inteligência Financeira', 'Inteligência Financeira - Oficial ou Praça - 1'),
        ('CEP_Inteligência Cibernética', 'Operações de Inteligência no Ambiente Cibernético - Oficial ou Praça - 1'),
        ('CEP_Armeiro', 'Armeiro - Cb PM ou Sd PM - 1'),
        ('CEP_Condutores Produtos Perigosos', 'Condutores de Veículos de Transporte de Produtos Perigosos - Oficial ou Praça - 1'),
        ('CEP_Condutores Emergência', 'Condutores de Veículos de Emergência - Oficial ou Praça - 1'),
        ('CEP_Condutores Transporte Coletivo', 'Condutores de Veículos de Transporte Coletivo de Passageiros - Oficial ou Praça - 1'),
        ('EEP_Atendente COPOM', 'Atendente de Emergência do COPOM - Civis - 1'),
        ('EEP_Operação Ferramentas Inteligentes', 'Operação de Ferramentas Inteligentes - Praça - 1'),
        ('EEP_Supervisão COPOM', 'Supervisão Operacional do COPOM - Subten PM e Sgt PM - 1'),
        ('CEP_Operador COPOM', 'Operador de COPOM - Cb PM e Sd PM - 1'),
        ('CEP_Investigação PM', 'Investigação Policial Militar - Oficial ou Praça - 1'),
        ('CEP_PJM_Praças', 'Polícia Judiciária Militar - Subten PM ou Sgt PM - 1'),
        ('CEP_PJM_Oficiais', 'Polícia Judiciária Militar - Oficial - 2,5'),
        ('CEP_Policiamento Ambiental_Praça', 'Policiamento Ambiental - Praça - 1'),
        ('CEP_Fiscalização Madeireira', 'Fiscalização de Atividade Madeireira - Oficiais e Praças - 1'),
        ('CEP_Direção 4x4', 'Direção Policial Preventiva de Viaturas com Tração 4x4 - Oficial e Praça - 1'),
        ('EEP_Manejo Animais Silvestres', 'Identificação e Manejo de Animais Silvestres - Praça - 1'),
        ('EEP_Geoprocessamento Ambiental', 'Geoprocessamento Aplicado ao Policiamento Ambiental - Praça - 1'),
        ('CEP_Policiamento Náutico', 'Técnicas de Policiamento Náutico - Oficial e Praça - 1'),
        ('EEP_Identificação Florestas', 'Identificação de Formações Florestais - Praça - 1'),
        ('EEP_Identificação Fauna Marinha', 'Identificação de Animais da Fauna Marinha - Praça - 1'),
        ('CEP_Policiamento Ambiental_Oficial', 'Policiamento Ambiental - Oficial - 2,5'),
        ('CEP_Fiscalização Transporte Perigosos', 'Fiscalização do Transporte Rodoviário de Produtos Perigosos - Oficial ou Praça - 1'),
        ('CEP_Policiamento Trânsito Rodoviário_Praça', 'Policiamento de Trânsito Rodoviário - Praça - 1'),
        ('CEP_Policiamento Trânsito Rodoviário_Oficial', 'Policiamento de Trânsito Rodoviário - Oficial - 2,5'),
        ('CEP_Patrulhamento Tático Rodoviário', 'Patrulhamento Tático Ostensivo Rodoviário - Oficial ou Praça - 1'),
        ('CEP_Policiamento Trânsito Urbano_Praça', 'Policiamento de Trânsito Urbano - Praça - 1'),
        ('CEP_Policiamento Trânsito Urbano_Oficial', 'Policiamento de Trânsito Urbano - Cap PM/Ten PM - 2,5'),
        ('CEP_Capacitação Tutores EAD', 'Capacitação de Tutores para Educação a Distância - Oficiais e Praças - 1'),
        ('CEP_Finanças Públicas_Oficiais', 'Finanças Públicas (Oficiais) - Oficiais - 2,5'),
        ('CEP_Finanças Públicas_Praças', 'Finanças Públicas (Praças) - Praças - 1'),
        ('EEP_Auxiliar Encarregado Adiantamentos', 'Auxiliar de Encarregado de Adiantamentos - Praça - 1'),
        ('EEP_Gestão de Contratos', 'Gestão de Contratos - Oficial - 2,5'),
        ('CEP_Técnico Gestão Logística', 'Técnico em Gestão Logística e Patrimonial - Praça - 1'),
        ('CEP_Administrador Gestão Logística', 'Administrador em Gestão Logística e Patrimonial - Oficiais - 2,5'),
        ('EEP_Operador RH', 'Operador de Sistemas de Recursos Humanos - Cb PM ou Sd PM - 1'),
        ('CEP_Técnico RH', 'Técnico em Recursos Humanos - Subten PM ou Sgt PM - 1'),
        ('CEP_Administrador RH', 'Administrador de Recursos Humanos - Oficial - 2,5'),
        ('CEP_Direitos Humanos_Praça', 'Direitos Humanos - Praça - 1'),
        ('PROERD', 'Curso Especial Formação de Docência do PROERD – Programa Educacional de Resistência às Drogas e à Violência - Oficial ou Praça - 1'),
        ('CEP_Direitos Humanos_Oficial', 'Direitos Humanos - Oficial - 2,5'),
        ('EEP_Policiamento Bases Comunitárias', 'Policiamento de Bases Comunitárias - Praça - 1'),
        ('CEP_Multiplicador Polícia Comunitária', 'Curso Nacional de Multiplicador de Polícia Comunitária - Oficiais e Praças - 1'),
        ('CEP_Multiplicador Internacional PC', 'Curso Internacional de Multiplicador de Polícia Comunitária - Oficial ou Praça - 1'),
        ('CBEF', 'Curso de Bacharel em Educação Física - Oficial ou Praça - 2,5 - 1º, 2º e 3º CENS'),
        ('CEP_Docência Tiro Giraldi', 'Docência para Tiro Defensivo na Preservação da Vida – "Método Giraldi®" - Oficiais, Subten PM ou Sgt PM - 1'),
        ('CEP_Força Tática_Oficial', 'Força Tática - Cap PM ou Ten PM - 2,5'),
        ('CEP_Força Tática_Subten_Sgt', 'Força Tática - Subten PM ou Sgt PM - 1'),
        ('CEP_Força Tática_Praça', 'Força Tática - Cb PM e Sd PM - 1'),
        ('CEP_Defesa Pessoal', 'Defesa Pessoal Policial - Oficiais e Praças - 1'),
        ('EEP_Multiplicador Taser', 'Multiplicador de Arma de Incapacitação Neuromuscular - Oficial, Subten PM ou Sgt PM - 1'),
        ('EEP_Policiamento Bicicletas', 'Policiamento com Bicicletas - Oficial ou Praça - 1'),
        ('CEP_Operação Viaturas Bombeiro', 'Operação de Viaturas de Bombeiro - Cb PM ou Sd PM - 1'),
        ('EEP_Abordagem Suicídio', 'Abordagem Técnica a Tentativas de Suicídio - Oficiais e Praças - 1'),
        ('CEP_Bombeiros_Civis', 'Bombeiros - Civis - 1'),
        ('CEP_Salvamento Aquático', 'Salvamento Aquático - Oficial ou Praça - 1'),
        ('CEP_Docência Resgate', 'Docência de Resgate e Emergência Médicas - Oficial, Subten PM ou Sgt PM - 1'),
        ('CEP_AEPP', 'Atendimento à Emergência com Produtos Perigosos (AEPP) - Oficial, Subten PM ou Sgt PM - 1'),
        ('CEP_Mergulho Autônomo', 'Mergulho Autônomo - Oficial ou Praça - 1'),
        ('CEP_Operações Bote Salvamento', 'Operações com Bote de Salvamento Inflável - Oficial ou Praça - 1'),
        ('CEP_Salvamento Terrestre', 'Salvamento Terrestre - Oficial ou Praça - 1'),
        ('EEP_Salvamento Veicular', 'Salvamento Veicular - Oficial ou Praça - 1'),
        ('CBS', 'Bombeiros - Sgt PM - 1'),
        ('CEP_Guarda-Vidas', 'Guarda-Vidas - Oficial ou Praça - 1'),
        ('CEP_Salvamento Alturas', 'Salvamento em Alturas - Oficial ou Praça - 1'),
        ('CEP_Bombeiros_Praça', 'Bombeiros - Cb PM ou Sd PM - 1'),
        ('CEP_Condução Motocicleta Emergência', 'Condução de Motocicletas em Situação de Emergência - Cb PM ou Sd PM - 1'),
        ('EEP_Busca Estruturas Colapsadas', 'Busca e Resgate em Estruturas Colapsadas - Oficial ou Praça - 1'),
        ('EEP_Técnicas Direção Preventiva', 'Técnicas de Direção Policial Preventiva - Cb PM ou Sd PM - 1'),
        ('CEP_Docência Direção Preventiva', 'Docência de Técnicas de Direção Policial Preventiva - Oficial, Subten PM ou Sgt PM - 1'),
        ('CFS_1', 'Curso Superior de Tecnólogo de Polícia Ostensiva e Preservação da Ordem Pública I - Cb PM ou Sd PM - 2'),
        ('CFS_2', 'Curso Superior de Tecnólogo de Polícia Ostensiva e Prevenção da Ordem Pública-II - 2º Sgt PM - 2'),
        ('CEP_Técnicas de Ensino', 'Técnicas de Ensino - Praça - 1'),
        ('CEP_Polícia Montada_Praça', 'Polícia Montada - Praça - 1'),
        ('CEP_Auxiliar Veterinário', 'Auxiliar Veterinário - Praça - 1'),
        ('CEP_Ferrador de Solípedes', 'Ferrador de Solípedes - Cb PM ou Sd PM - 1'),
        ('CEP_Polícia Montada_Oficial', 'Polícia Montada - Cap PM ou Ten PM - 2,5'),
        ('EEP_Desenvolvimento Psicoemocional', 'Desenvolvimento Psicoemocional - Oficial ou Praça - 1'),
        ('EAP', 'Estágio de Atualização Profissional - Oficiais e Praças - 1'),
